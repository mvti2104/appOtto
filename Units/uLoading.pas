...
uses System.SysUtils, System.UITypes, FMX.Types, FMX.Controls, FMX.StdCtrls, FMX.Objects, FMX.Effects, FMX.Layouts, FMX.Forms, FMX.Graphics, FMX.Ani,
...
type
  ...
  public
    ...
    class procedure ToastMessage(const Frm : Tform; const msg: string; alinhamento: TAlignLayout = TAlignLayout.Bottom;
                                 cor_fundo: Cardinal = $FF22AF70; cor_fonte: Cardinal = $FFFFFFFF; duracao: integer = 4);
end;
...
class procedure TLoading.ToastMessage(const Frm : Tform; const msg: string; alinhamento: TAlignLayout = TAlignLayout.Bottom;
                                      cor_fundo: Cardinal = $FF22AF70; cor_fonte: Cardinal = $FFFFFFFF; duracao: integer = 4);
var
  FService: IFMXVirtualKeyboardService;
begin
